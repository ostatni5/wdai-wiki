...
export class AddCourseComponent implements OnInit {
  ...
  addCourseForm = new FormGroup({
    ...
    semester: new FormControl(null,[Validators.required,Validators.min(1),Validators.max(7)]),
    capacity: new FormControl(null,[Validators.required,Validators.min(1),Validators.max(250)]),
